...
all_fw_cut_indices = [[i for i, letter in enumerate(fw_strand) if letter == ' '] for fw_strand in fw_strands]
all_bw_cut_indices = [[i for i, letter in enumerate(bw_strand) if letter == ' '] for bw_strand in bw_strands]
