...
def connect():
    ...
    msg = {}
    sio.emit('chat message', {'message': 'ahouahouahouahouahoua !!! from the server with Auth', 'character': 'picabot', 'user':'my laptop'})
    print('sent')
...
userAndPass = b64encode(b"guest:vuVpm77e").decode("ascii")
sio.connect('https://spark.theatrophone.fr', { 'Authorization' : 'Basic %s' %  userAndPass })
sio.wait()
